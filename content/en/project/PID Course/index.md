...
{{< figure src="album/run.png" caption="Real-time Simulation" numbered="true" width="500px" >}}
...
{{< figure src="album/plot.png" caption="Data Visualization" numbered="true" width="500px" >}}
